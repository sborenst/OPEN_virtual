...
virt-install --connect qemu:///system --ram 1024 -n fedora_23 -r 2048 --os-type=linux --os-variant=fed23 --disk path=fuse-dev_libvirt.qcow2,device=disk,format=qcow2 --vcpus=2 --vnc --noautoconsole --import
---- 
