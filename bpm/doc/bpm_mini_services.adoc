...
-----
cd $BPM_DOCKER
docker build --rm=true -t prod/storage-bpmsuite storage-bpmsuite
docker build --rm=true -t prod/mysql-bpmsuite mysql-bpmsuite
docker build --rm=true -t prod/postgresql-bpmsuite crunchy-node
docker build --rm=true -t prod/hq-bpmsuite hq-bpmsuite
docker build --rm=true -t prod/bpm-bpmsuite bpm-bpmsuite
docker build --rm=true -t course/open-bpmsuite open-bpmsuite
-----
...
==== Start `Full-Profile` `open-bpmsuite` container:

-----
prod/bpm-bpmsuite/bin/start.sh -c bpm-full -useRemoteHQ -useSharedBPMFilesystem -useLinkedMySQL -i open-bpmsuite
-----
...
-----
prod/bpm-bpmsuite/bin/start.sh -c bpm-ui -useRemoteHQ -useSharedBPMFilesystem -useLinkedMySQL -i open-bpmsuite
-----

or

-----
prod/bpm-bpmsuite/bin/start.sh -c bpm-ui -useRemoteHQ -useSharedBPMFilesystem -useLinkedPostgreSQL
-----
...
-----
prod/bpm-bpmsuite/bin/start.sh -c bpm-exec-server-0 -useRemoteHQ -useLinkedMySQL -useSharedBPMFilesystem -execServer
-----
