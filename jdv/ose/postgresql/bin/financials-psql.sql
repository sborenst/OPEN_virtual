...
grant all privileges on database brokerinfo to jdv;
...
grant all privileges on database apaccustomers to jdv;
...
grant all privileges on database eucustomers to jdv;
...
grant all privileges on database products to jdv;
...
grant all privileges on database uscustomers to jdv;
